# ----------------------------------------------------------------------------
# path: quorem/db/forms/generic_views.py
# authors: Mike Hall
# modified: 2022-06-16
# description: This file contains all views that are for autocomplete widgets.
#              These widgets are used across many forms and provide JSON
#              output to populate as you type into a textbox.
# ----------------------------------------------------------------------------
